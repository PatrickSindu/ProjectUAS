...
<html class="no-js" lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        <div class="header-bottom-wrapper">
                            <div class="logo-2 furniture-logo ptb-30">
                                <a href="/">
                                    <img height="60" style="transform:scale(1.5);object-fit: cover;" src="{{ asset('frontend/assets/img/logo/MbangunJayaLogo.png') }}" alt="">
                                </a>
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="furniture-bottom-wrapper">
                            <div class="furniture-login">
                                <ul>
                                    @guest
                                        <li>Dapatkan Access: <a href="{{ route('login') }}">Masuk</a></li>
                            ...
                            <div class="furniture-search">
                                <form>
                                    <input placeholder="Mencari . . ." type="text" name="q" autocomplete="off" id="search">
                                    <button disabled>
                                        <i class="ti-search"></i>
                                    </button>
                                </form>
        ...
        <footer class="footer-area">
            <div class="footer-top-area pt-70 pb-35 wrapper-padding-3">
                <div class="container-fluid">
                    <div class="widget-wrapper">
                        <div class="footer-widget mb-50">
                        <img height="60" style="transform:scale(1.5);object-fit: cover;" src="{{ asset('frontend/assets/img/logo/MbangunJayaLogo.png') }}" alt="">
                            <div class="footer-about-2">
                                <p>MbangunJaya adalah toko bangunan <br> yang menyediakan material <br> dan perlengkapan konstruksi berkualitas. <br> Layanan kami ramah dan profesional,<br> dengan jasa pengiriman cepat dan aman.</p>
                            </div>
                        </div>
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>Magelang <br>Indonesia- 1976</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>+62 (08) 5712263278 <br>+62 (08) 5796416822</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="mailto:patricksindu73@gmail.com"> patricksindu73@gmail.com</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>Copyright © <a>SinduIndra</a> 2024 . All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
